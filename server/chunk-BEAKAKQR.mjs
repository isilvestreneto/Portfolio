...
nx affected:e2e`),n()()(),e(168,"p",54),t(169," Carefully crafted with "),r(),e(170,"svg",55),i(171,"path",56),n()()()())},dependencies:[h],styles:[`
    ...
    `],encapsulation:2})}return a})();var k=(()=>{class a{title="portfolio";static \u0275fac=function(l){return new(l||a)};static \u0275cmp=m({type:a,selectors:[["app-root"]],standalone:!0,features:[s],decls:2,vars:0,template:function(l,E){l&1&&i(0,"app-nx-welcome")(1,"router-outlet")},dependencies:[w,v,x]})}return a})();var S=[];var y={providers:[u(),p({eventCoalescing:!0}),b(S)]};var C={providers:[f()]},z=c(y,C);var V=()=>g(k,z),O=V;export{O as a};
